...
import type { ToolCapability } from "@/domain/courseHome/types"
...
<template>
  ...
  >
    ...
    <i
      class="pi pi-chevron-right text-sm text-slate-400 transition group-hover:translate-x-0.5 group-hover:text-chamilo-700"
      aria-hidden="true"
    />
  </RouterLink>
</template>
